...
@section('content')
    <div class="container-fluid">
        ...
        @endif
        <div class="row mb-4">
            <form action="{{ route('categorias.index') }}" method="GET" class="input-group search-area d-inline-flex mr-3 search-form">
                <div class="col-6">
                ...
                <div class="col-2">
                    <div class="d-none d-lg-block">
                        @can('permissoes_tela', 'permissao_para_cadastrar_categoria')
                            <a href="{{ route('categorias.create') }}" class="btn btn-primary btn-rounded btn-sm">+ Add categoria</a>
                        @endcan
                    </div>
                </div>
            </form>
