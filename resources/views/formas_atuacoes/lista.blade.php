...
@section('content')
    <div class="container-fluid">
        ...
        @endif
        <div class="row mb-4">
            <form action="{{ route('formas_atuacoes.index') }}" method="GET" class="input-group search-area d-inline-flex mr-3 search-form">
                <div class="col-6">
                ...
                <div class="col-2">
                    <div class="d-none d-lg-block">
                        @can('permissoes_tela', 'permissao_para_cadastrar_forma_atuacao')
                            <a href="{{ route('formas_atuacoes.create') }}" class="btn btn-primary btn-rounded btn-sm">+ Add forma de atuação</a>
                        @endcan
                    </div>
                </div>
            </form>
