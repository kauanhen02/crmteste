...
@section('content')
    <div class="container-fluid">
        ...
        @endif
        <div class="row mb-4">
            <form action="{{ route('volumes.index') }}" method="GET" class="input-group search-area d-inline-flex mr-3 search-form">
                <div class="col-6">
                ...
                <div class="col-2">
                    <div class="d-none d-lg-block">
                        @can('permissoes_tela', 'permissao_para_cadastrar_volume')
                            <a href="{{ route('volumes.create') }}" class="btn btn-primary btn-rounded btn-sm">+ Add volume</a>
                        @endcan
                    </div>
                </div>
            </form>
