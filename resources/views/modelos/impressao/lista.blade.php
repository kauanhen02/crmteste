...
@section('content')
    <div class="container-fluid">
        ...
        @endif
        <div class="row mb-4">
            <form action="{{ route('modelosImpressao.index') }}" method="GET" class="input-group search-area d-inline-flex mr-3 search-form">
                <div class="col-6">
                ...
                <div class="col-2">
                    <div class="d-none d-lg-block">
                        @can('permissoes_tela', 'permissao_para_cadastrar_modelo_impressao')
                            <a href="{{ route('modelosImpressao.create') }}" class="btn btn-primary btn-rounded btn-sm">+ Add modelo impressão</a>
                        @endcan
                    </div>
                </div>
            </form>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="table-responsive table-lista">
                    @include('modelos.impressao.table')
                </div>
            </div>
        </div>
    </div>
